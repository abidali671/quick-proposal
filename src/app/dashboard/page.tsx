  ...
  return (
    <ProtectedRoute>
      <div className="overflow-hidden h-full w-full absolute">
        <div className="grid md:grid-cols-[400px_1fr] h-full w-full max-md:grid-rows-[auto_1fr]">
          <div className="md:grid md:grid-rows-[auto_auto_1fr] border-r border-gray-200 shadow-sm overflow-hidden">
            <form
              onSubmit={handleSend}
              className="bg-white grid grid-cols-1 gap-4 p-5"
            >
              <Input
                required
                label="Job Title"
              ...
              <label className="flex items-center gap-2 text-sm font-medium">
                <input
                  ...
                  onChange={(e) =>
                    handleUpdateValue("emojis", e.target.checked)
                  }
                />
                <p>Include Emojis</p>
              </label>
            ...
            <div
              className={
                "flex flex-col gap-1 w-full max-md:fixed max-md:h-screen max-md:w-10/12 z-50 top-[56px] bg-white transition-all duration-30000 " +
                (showHistory ? "left-0" : "-left-full")
              }
            >
              <div className="flex items-center gap-1 pb-1 px-5 pt-5">
                <History className="text-gray-500 h-4 w-4" />
                <h6 className="text-xs font-semibold text-gray-400">HISTORY</h6>
              </div>

              <div className="w-full h-full relative">
                <div className="overflow-auto px-5 pb-20 absolute top-0 left-0 h-full w-full">
          ...
          <div className="h-full bg-white w-full flex flex-col gap-2 p-5 relative">
            <div className="h-full w-full border border-gray-200 relative">
